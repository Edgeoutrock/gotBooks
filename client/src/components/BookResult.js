...
import {Row, Col, Container} from "./index.js"
class BookResult extends React.Component {
    ...
    handleSaveClick = function(e) {
        ...
        e.preventDefault();
        axios.post("/api/books", bookData).then(
            (response) => {
    ...
    handleDeleteClick(e) {
        ...
        e.preventDefault();
        axios.delete(`/api/books/${this.props.id}`).then(
            (response) => {
                console.log(response);
                      ...
                      <div className="bookResult" id={(this.props.id)? this.props.id: null} style={{display: this.state.deleted? "none" : "block"}}>
                          <div className="row">
                              ...
                              <div className="btnDiv">
                                  {
                                      // if link to this.props exists include View button else do not
                                  ...
                                  }
                                  {
                                      ...
                                      <>
                                       <button type="button" name="save" onClick={this.handleSaveClick} disabled={this.state.saved}>{(this.state.saved)? "Saved" : "Save"}</button> 
